...
public class Main {
    ...
    private static void rentCarProcess(String customerID) throws ClassNotFoundException, SQLException {
        ...
        if (!rs.next()) {
            ...
            if (option == 0) {
                ...
                System.out.println();
                carMenuASCustomer(String.valueOf(option), customerID);
            }
    ...
    private static void carMenuASCustomer(String companyID, String customerID) throws SQLException, ClassNotFoundException {
        Statement stat = getStatement();
